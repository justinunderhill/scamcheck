...
- [x] **Shortener expansion list** — RESOLVED: seed list in `app/data/shorteners.txt`, HEAD-follow expansion (see above).
- [x] **Impersonated-brand list** — RESOLVED: seed list in `app/data/brands.txt` + conservative lookalike rules (see above).
